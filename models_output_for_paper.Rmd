...
We also adjusted two of our categorical variables to include only dummies for one of the categories based on the previous output, replacing `race` with `black` and `region` with `west`.
